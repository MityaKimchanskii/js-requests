...
// PROBLEM 2
/*
    Create a function that changes sayHelloButton's background color to black and its text color to white (you can use the .
...
const ohMy = () => {return axios.get('http://localhost:3000/animals')
    .then(res => {
        // return res.data
...
const queryCatcher = () => {
    axios.get('http://localhost:3000/query-test?q=Dmitrii').then(res => {
        console.log(res.data)
    })
}
